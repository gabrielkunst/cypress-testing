...
export function TaskForm() {
  ...
  return (
    ...
    >
      ...
      />
      <button
        data-test="task-form-button"
        className="flex items-center justify-center gap-2 p-4 font-bold transition-colors duration-300 rounded-lg text-customGray100 bg-customDarkBlue hover:bg-customBlue"
      >
        Criar
        <PlusCircle />
      </button>
